...
def get_blog_list_common_data(request, blogs_all_list):
	...
	# 获取当前页码前后两页的范围，并且对超范围的页码进行处理
	page_range = [page for page in range(current_page_num - 2, current_page_num + 3) if page >= 1 and page <= paginator.num_pages]
	# 加上省略页码标记
	if page_range[0] - 1 >= 2:
		page_range.insert(0, '...')
